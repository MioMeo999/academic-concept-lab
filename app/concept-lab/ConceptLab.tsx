  ...
  return (
    <header className="site-header">
      ...
      <nav aria-label="Prototype pages">
        <a href="/concept-lab/prototypes">New prototypes</a>
...
export function ConceptLabHome() {
  ...
  return (
    <div className="lab-home">
      ...
      <main>
        <section className="home-hero"><p className="eyebrow">Three directions · one evidence base</p><h1>How should rigorous research <em>feel</em>?</h1><p>Compare three visual languages across the same theory and empirical paper. Art direction changes; academic claims do not.</p><div className="home-links"><a href="/concept-lab/prototypes">Explore the new route prototypes <span>→</span></a><a href="/concept-lab/theory/person-environment-fit?concept=editorial">Open the preserved theory <span>→</span></a><a href="/concept-lab/paper/tuned-out-or-dialed-in?concept=editorial">Open the preserved paper <span>→</span></a></div></section>
