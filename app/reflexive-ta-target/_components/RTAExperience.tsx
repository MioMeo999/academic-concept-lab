...
import RTAInteractive from "./RTAInteractive";
...
export default function RTAExperience({ variant = "target" }: { variant?: "target" | "canonical" }) {
  return (
    <div className="rta-page">
      ...
      <section className="rta-close"><p className="rta-hand">analysis leaves traces · keep the path visible</p><a href="/concept-lab/library">← Return to the atlas</a><span>{variant === "target" ? "Reflexive Thematic Analysis · isolated visual prototype" : "Reflexive Thematic Analysis · Academic Concept Lab method"}</span></section>
    </div>
  );
}
