...
import { GroupingStudio } from "./_components/GroupingStudio";
...
export default function GestaltTargetPage() {
  return (
    <main id="gestalt-target-main">
      ...
      <section id="provenance" className="target-section provenance-section" aria-labelledby="provenance-title">
        <div className="provenance-head"><p className="eyebrow">PROVENANCE / SOURCES / RELATIONS</p><h2 id="provenance-title">Keep the marks<br /><em>attached to the claims.</em></h2></div>
